...
this.=f();this.hoverable=f();this.focusable=f();if(a!==this){f.data(a,this.widgetName,this);f.data(a,this.widgetFullName,this);this._on({remove:function(c){if(c.target===a){this.destroy();
...
this..unbind(this.eventNamespace);this.hoverable.removeClass("ui-state-hover");this.focusable.removeClass("ui-state-focus");},_destroy:f.noop,widget:function(){return this.element;
...
},disable:function(){return this._setOption("disabled",true);},_on:function(a,b){if(!b){b=a;a=this.element;}else{a=f(a);this.=this..add(a);
